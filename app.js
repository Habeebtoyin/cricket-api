...
// const bytecode = require('./contractbyte');

// require('../web3/abi.json');
// require('../web3/conttractbyte.txt')
...
// const abidirectory = path.join("web3", "abi.json")

// const bytedirectory = path.join("web3", "contractbyte.txt");

// const contractAbi = JSON.parse(fs.readFileSync(abi, 'utf8'));

// const contractBytecode = '0x' + fs.readFileSync(bytecode, 'utf8').trim();
...
// cricket livematch Route
 app.get('/cricket-liveMatch', async (req, res) => {

const options = {
  method: 'GET',
  url: 'https://cricketapi21.p.rapidapi.com/api/cricket/matches/live',
  headers: {
    'X-RapidAPI-Key': 'ea04d7f684msh5d46c736dc19db5p15f419jsn892931075599',
...
const options = {
  method: 'GET',
  url: 'https://cricketapi21.p.rapidapi.com/api/cricket/match/11067865/odds',
  headers: {
    'X-RapidAPI-Key': 'ea04d7f684msh5d46c736dc19db5p15f419jsn892931075599',
    'X-RapidAPI-Host': 'cricketapi21.p.rapidapi.com'
  }
